...
void Application::Draw_Graph(const Oscilliscope& scope) {
    for (int i = 0; i < GRID_WIDTH; i++) {
        ...
        ST7735_DrawPixel(i, point, ST7735_BLUE);
        ST7735_DrawPixel(i, point+1, ST7735_BLUE);
        ST7735_DrawPixel(i+1, point, ST7735_BLUE);
        ST7735_DrawPixel(i+1, point+1, ST7735_BLUE);
    }
}
